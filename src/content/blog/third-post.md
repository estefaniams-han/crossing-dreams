...
<a href="https://open.spotify.com/user/rx5bwbvv6wpfohd740imi1uzg" target="_blank" rel="noopener noreferrer" style="display:block;margin:1.8em 0;padding:1.2em 1.6em;background:linear-gradient(135deg,#FCE8F2,#FEF7F2);border:1px solid #EDD8E4;border-left:4px solid #C06080;border-radius:16px;text-decoration:none;transition:box-shadow 0.2s,transform 0.2s;" onmouseover="this.style.boxShadow='0 8px 32px rgba(180,90,120,0.16)';this.style.transform='translateY(-2px)'" onmouseout="this.style.boxShadow='none';this.style.transform='none'">
  <span style="display:block;font-family:'Nunito',sans-serif;font-size:0.72em;font-weight:600;letter-spacing:0.1em;color:#C06080;text-transform:uppercase;margin-bottom:0.4em;">♪ &nbsp; Spotify</span>
  <span style="display:block;font-family:'Cormorant Garamond',Georgia,serif;font-size:1.3em;font-weight:400;color:#3D2B2E;margin-bottom:0.3em;">BeatTape</span>
  <span style="display:block;font-family:'Nunito',sans-serif;font-size:0.88em;color:#9E7B80;line-height:1.6;">Lo-fi beats perfect for long study sessions — calm enough to focus, present enough to not feel alone.</span>
  <span style="display:inline-block;margin-top:0.8em;font-family:'Nunito',sans-serif;font-size:0.78em;font-weight:600;color:#C06080;letter-spacing:0.05em;">Listen on Spotify →</span>
</a>

I don't study with K-pop, even though I love it. Lyrics in any language activate a different part of my brain and I end up listening instead of focusing. Instrumental only when there's reading or writing involved.
...
<iframe style="border-radius:16px;margin:1.2em 0 1.8em;" src="https://open.spotify.com/embed/track/100N8P8WYnz9eCYuLYGflV?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
