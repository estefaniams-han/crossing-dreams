...
<div style="margin:2.5em 0;padding:1.8em 2em;background:var(--white);border:1px solid var(--border);border-radius:16px;font-family:'Nunito',sans-serif;">
  <div style="font-family:'Cormorant Garamond',Georgia,serif;font-size:0.72em;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:var(--pink-dark);margin:0 0 1.2em;">✦ &nbsp; Cost Summary</div>
  <div style="display:flex;justify-content:space-between;padding:0.55em 0;border-bottom:1px dashed var(--border);font-size:0.9em;color:var(--text);">
    <span>Notarized copies &nbsp;<span style="color:var(--text-light);font-size:0.85em;">×2 docs</span></span>
    <span style="font-weight:600;">~$11 USD</span>
  </div>
  <div style="display:flex;justify-content:space-between;padding:0.55em 0;border-bottom:1px dashed var(--border);font-size:0.9em;color:var(--text);">
    <span>Apostilles &nbsp;<span style="color:var(--text-light);font-size:0.85em;">×5 docs</span></span>
    <span style="font-weight:600;">~$98 USD</span>
  </div>
  <div style="display:flex;justify-content:space-between;padding:0.55em 0;border-bottom:1px dashed var(--border);font-size:0.9em;color:var(--text);">
    <span>Certified translations &nbsp;<span style="color:var(--text-light);font-size:0.85em;">13 pages + tax</span></span>
    <span style="font-weight:600;">~$296 USD</span>
  </div>
  <div style="display:flex;justify-content:space-between;padding:0.55em 0;border-bottom:1px dashed var(--border);font-size:0.9em;color:var(--text);">
    <span>DHL to Korea &nbsp;<span style="color:var(--text-light);font-size:0.85em;">after coupon</span></span>
    <span style="font-weight:600;">~$101 USD</span>
  </div>
  <div style="display:flex;justify-content:space-between;padding:0.55em 0;border-bottom:1px dashed var(--border);font-size:0.9em;color:var(--text-light);">
    <span>Printing, transport & other small costs</span>
    <span style="font-weight:600;">varies</span>
  </div>
  <div style="display:flex;justify-content:space-between;padding:0.8em 0 0;font-size:1em;color:var(--pink-dark);">
    <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15em;font-weight:600;">Total spent</span>
    <span style="font-family:'Cormorant Garamond',Georgia,serif;font-size:1.3em;font-weight:600;">~$842 USD</span>
  </div>
</div>
